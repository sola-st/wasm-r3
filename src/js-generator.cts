...
import { ReplayToWriteStream, Result, Store, Call, TableCall, MemGrow, TableSet, TableGrow, GlobalSet, Context } from "./replay-generator.cjs";
...
async function writeResults(stream: WriteStream, results: Result[], funcGlobal: string) {
    let current = 0
