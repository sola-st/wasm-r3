...
function runSliceDice(replayWasmPath: string, fidx: string) {
  ...
  const command = `/home/doehyunbaek/wasm-r3/crates/target/release/slice_dice ${replayWasmPath} ${fidx} 1`;
...
function getSubsetFidx(replayWasmPath: string, name: string) {
  ...
  const command = `/home/doehyunbaek/wasm-r3/crates/target/release/slice_dice ${replayWasmPath}`;
