...
Wasabi.module.info = {"functions":[{"type":"|","import":["env","changeMem"],"export":[],"locals":"","instrCount":0},{"type":"|","import":null,"export":["main"],"locals":"","instrCount":5}],"globals":[],"start":null,"tables":[],"memories":[{"import":["env","memory"],"export":["__wasabi_memory0"]}],"tableExportNames":[],"memoryExportNames":["__wasabi_memory0"],"globalExportNames":[],"brTables":[],"originalFunctionImportsCount":1};
