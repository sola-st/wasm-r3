...
Wasabi.module.info = {"functions":[{"type":"ii|i","import":["env","add"],"export":[],"locals":"","instrCount":0},{"type":"ii|","import":null,"export":["main"],"locals":"","instrCount":11}],"globals":[],"start":null,"tables":[],"memories":[],"tableExportNames":[],"memoryExportNames":[],"globalExportNames":[],"brTables":[],"originalFunctionImportsCount":1};
