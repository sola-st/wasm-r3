...
Wasabi.module.info = {"functions":[{"type":"F|","import":["env","changeGlobal"],"export":[],"locals":"","instrCount":0},{"type":"|","import":null,"export":["main"],"locals":"","instrCount":5}],"globals":[{"import":null,"export":["global"],"valType":"f64"}],"start":null,"tables":[],"memories":[],"tableExportNames":[],"memoryExportNames":[],"globalExportNames":["global"],"brTables":[],"originalFunctionImportsCount":1};
