...
Wasabi.module.info = {"functions":[{"type":"|","import":["env","changeTable"],"export":[],"locals":"","instrCount":0},{"type":"|","import":["env","changeTable2"],"export":[],"locals":"","instrCount":0},{"type":"|i","import":["env","a"],"export":[],"locals":"","instrCount":0},{"type":"|i","import":["env","b"],"export":[],"locals":"","instrCount":0},{"type":"|i","import":null,"export":["main"],"locals":"","instrCount":11},{"type":"|i","import":null,"export":["foo"],"locals":"","instrCount":2},{"type":"|i","import":null,"export":["bar"],"locals":"","instrCount":2}],"globals":[],"start":null,"tables":[{"import":null,"export":["table"],"refType":"funcref"}],"memories":[],"tableExportNames":["table"],"memoryExportNames":[],"globalExportNames":[],"brTables":[],"originalFunctionImportsCount":4};
...
"call_indirect": function (func, instr, tableIdx, elemIdx) {
    Wasabi.analysis.call_pre({func, instr}, "call_indirect", Wasabi.resolveTableIdx(tableIdx, elemIdx), [], {tableIdx, elemIdx});
},
...
"table_get_M": function (func, instr, tableIdx, elemIdx, value) {
    Wasabi.analysis.table_get({func, instr}, {tableIdx, elemIdx}, value);
},
"drop_M": function (func, instr, value) {
    Wasabi.analysis.drop({func, instr}, value);
},
};
