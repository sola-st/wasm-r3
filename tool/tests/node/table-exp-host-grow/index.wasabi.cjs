...
Wasabi.module.info = {"functions":[{"type":"|i","import":["env","changeTable"],"export":[],"locals":"","instrCount":0},{"type":"|","import":null,"export":["main"],"locals":"","instrCount":4},{"type":"|","import":null,"export":["foo"],"locals":"","instrCount":1}],"globals":[],"start":null,"tables":[{"import":null,"export":["table"],"refType":"funcref"}],"memories":[],"tableExportNames":["table"],"memoryExportNames":[],"globalExportNames":[],"brTables":[],"originalFunctionImportsCount":1};
