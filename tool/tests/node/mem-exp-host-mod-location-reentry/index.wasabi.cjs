...
Wasabi.module.info = {"functions":[{"type":"|","import":["env","changeMemAfterReentry"],"export":[],"locals":"","instrCount":0},{"type":"|","import":["env","changeMemBeforeReentry"],"export":[],"locals":"","instrCount":0},{"type":"|","import":null,"export":["main"],"locals":"","instrCount":12},{"type":"|","import":null,"export":["reentry"],"locals":"","instrCount":4}],"globals":[],"start":null,"tables":[],"memories":[{"import":null,"export":["memory"]}],"tableExportNames":[],"memoryExportNames":["memory"],"globalExportNames":[],"brTables":[],"originalFunctionImportsCount":2};
