...
Wasabi.module.info = {"functions":[{"type":"|","import":["env","changeMem"],"export":[],"locals":"","instrCount":0},{"type":"|","import":null,"export":["main"],"locals":"","instrCount":5}],"globals":[],"start":null,"tables":[],"memories":[{"import":null,"export":["memory"]}],"tableExportNames":[],"memoryExportNames":["memory"],"globalExportNames":[],"brTables":[],"originalFunctionImportsCount":1};
