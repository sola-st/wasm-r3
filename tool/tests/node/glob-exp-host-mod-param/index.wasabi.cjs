...
Wasabi.module.info = {"functions":[{"type":"ii|","import":["env","changeGlobal"],"export":[],"locals":"","instrCount":0},{"type":"|","import":null,"export":["main"],"locals":"","instrCount":11}],"globals":[{"import":null,"export":["global1"],"valType":"i32"},{"import":null,"export":["global2"],"valType":"i32"}],"start":null,"tables":[],"memories":[],"tableExportNames":[],"memoryExportNames":[],"globalExportNames":["global1","global2"],"brTables":[],"originalFunctionImportsCount":1};
