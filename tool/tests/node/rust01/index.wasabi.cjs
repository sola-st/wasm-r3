...
Wasabi.module.info = {"functions":[{"type":"|i","import":null,"export":["return_one"],"locals":"iii","instrCount":11}],"globals":[{"import":null,"export":["__wasabi_global0"],"valType":"i32"},{"import":null,"export":["__data_end"],"valType":"i32"},{"import":null,"export":["__heap_base"],"valType":"i32"}],"start":null,"tables":[{"import":null,"export":["__wasabi_table0"],"refType":"funcref"}],"memories":[{"import":null,"export":["memory"]}],"tableExportNames":["__wasabi_table0"],"memoryExportNames":["memory"],"globalExportNames":["__wasabi_global0","__data_end","__heap_base"],"brTables":[],"originalFunctionImportsCount":0};
