...
Wasabi.module.info = {"functions":[{"type":"|","import":["env","changeGlobal"],"export":[],"locals":"","instrCount":0},{"type":"|","import":null,"export":["main"],"locals":"","instrCount":4}],"globals":[{"import":null,"export":["global"],"valType":"i32"}],"start":null,"tables":[],"memories":[],"tableExportNames":[],"memoryExportNames":[],"globalExportNames":["global"],"brTables":[],"originalFunctionImportsCount":1};
