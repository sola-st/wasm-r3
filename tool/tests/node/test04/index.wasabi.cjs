...
Wasabi.module.info = {"functions":[{"type":"ii|i","import":["env","add"],"export":[],"locals":"","instrCount":0},{"type":"FF|F","import":["env","sub"],"export":[],"locals":"","instrCount":0},{"type":"ff|F","import":["lib","add"],"export":[],"locals":"","instrCount":0},{"type":"|","import":null,"export":["main"],"locals":"","instrCount":17}],"globals":[],"start":null,"tables":[],"memories":[{"import":null,"export":["memory"]}],"tableExportNames":[],"memoryExportNames":["memory"],"globalExportNames":[],"brTables":[],"originalFunctionImportsCount":3};
...
"f32_const": function (func, instr, value) {
