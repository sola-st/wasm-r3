...
Wasabi.module.info = {"functions":[{"type":"ii|","import":["env","changeMem"],"export":[],"locals":"","instrCount":0},{"type":"|","import":null,"export":["main"],"locals":"","instrCount":7},{"type":"|","import":null,"export":["foo"],"locals":"","instrCount":4}],"globals":[],"start":null,"tables":[],"memories":[{"import":null,"export":["memory"]}],"tableExportNames":[],"memoryExportNames":["memory"],"globalExportNames":[],"brTables":[],"originalFunctionImportsCount":1};
...
"i32_load16_s": function (func, instr, memIdx, offset, align, addr, value) {
    Wasabi.analysis.load({func, instr}, "i32.load16_s", {memIdx, addr}, {offset, align}, value);
},
