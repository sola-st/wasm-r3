...
Wasabi.module.info = {"functions":[{"type":"|","import":null,"export":["main"],"locals":"","instrCount":1}],"globals":[],"start":null,"tables":[],"memories":[{"import":null,"export":["memory"]}],"tableExportNames":[],"memoryExportNames":["memory"],"globalExportNames":[],"brTables":[],"originalFunctionImportsCount":0};
