...
Wasabi.module.info = {"functions":[{"type":"|","import":null,"export":["main"],"locals":"","instrCount":3}],"globals":[{"import":["env","global"],"export":["__wasabi_global0"],"valType":"i32"}],"start":null,"tables":[],"memories":[],"tableExportNames":[],"memoryExportNames":[],"globalExportNames":["__wasabi_global0"],"brTables":[],"originalFunctionImportsCount":0};
