...
Wasabi.module.info = {"functions":[{"type":"|","import":["env","foo"],"export":[],"locals":"","instrCount":0},{"type":"|","import":null,"export":["main"],"locals":"","instrCount":2},{"type":"|","import":null,"export":["bar"],"locals":"","instrCount":1}],"globals":[],"start":null,"tables":[],"memories":[],"tableExportNames":[],"memoryExportNames":[],"globalExportNames":[],"brTables":[],"originalFunctionImportsCount":1};
