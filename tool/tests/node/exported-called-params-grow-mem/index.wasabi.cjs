...
Wasabi.module.info = {"functions":[{"type":"|","import":["env","foo"],"export":[],"locals":"","instrCount":0},{"type":"i|","import":null,"export":["main"],"locals":"","instrCount":5}],"globals":[],"start":null,"tables":[],"memories":[{"import":null,"export":["__wasabi_memory0"]}],"tableExportNames":[],"memoryExportNames":["__wasabi_memory0"],"globalExportNames":[],"brTables":[],"originalFunctionImportsCount":1};
