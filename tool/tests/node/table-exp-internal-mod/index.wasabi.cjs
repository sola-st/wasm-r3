...
Wasabi.module.info = {"functions":[{"type":"|i","import":null,"export":["main"],"locals":"","instrCount":7},{"type":"|","import":null,"export":[],"locals":"","instrCount":1},{"type":"|i","import":null,"export":[],"locals":"","instrCount":2},{"type":"|i","import":null,"export":[],"locals":"","instrCount":2}],"globals":[],"start":null,"tables":[{"import":null,"export":["table"],"refType":"funcref"}],"memories":[],"tableExportNames":["table"],"memoryExportNames":[],"globalExportNames":[],"brTables":[],"originalFunctionImportsCount":0};
