...
Wasabi.module.info = {"functions":[{"type":"|","import":["env","changeTable"],"export":[],"locals":"","instrCount":0},{"type":"|i","import":["env","a"],"export":[],"locals":"","instrCount":0},{"type":"|i","import":["env","b"],"export":[],"locals":"","instrCount":0},{"type":"|i","import":null,"export":["main"],"locals":"","instrCount":7},{"type":"|i","import":null,"export":["foo"],"locals":"","instrCount":2}],"globals":[],"start":null,"tables":[{"import":["env","table"],"export":["__wasabi_table0"],"refType":"funcref"}],"memories":[],"tableExportNames":["__wasabi_table0"],"memoryExportNames":[],"globalExportNames":[],"brTables":[],"originalFunctionImportsCount":3};
