...
Wasabi.module.info = {"functions":[{"type":"|","import":["env","foo"],"export":[],"locals":"","instrCount":0},{"type":"|","import":["env","bar"],"export":[],"locals":"","instrCount":0},{"type":"i|","import":null,"export":["main"],"locals":"","instrCount":7}],"globals":[],"start":null,"tables":[],"memories":[],"tableExportNames":[],"memoryExportNames":[],"globalExportNames":[],"brTables":[],"originalFunctionImportsCount":2};
