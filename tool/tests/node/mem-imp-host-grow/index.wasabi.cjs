...
Wasabi.module.info = {"functions":[{"type":"|i","import":["env","changeMem"],"export":[],"locals":"","instrCount":0},{"type":"|","import":null,"export":["main"],"locals":"","instrCount":4}],"globals":[],"start":null,"tables":[],"memories":[{"import":["env2","mem"],"export":["__wasabi_memory0"]}],"tableExportNames":[],"memoryExportNames":["__wasabi_memory0"],"globalExportNames":[],"brTables":[],"originalFunctionImportsCount":1};
