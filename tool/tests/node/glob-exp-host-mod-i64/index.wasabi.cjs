...
Wasabi.module.info = {"functions":[{"type":"I|","import":["env","changeGlobal"],"export":[],"locals":"","instrCount":0},{"type":"|","import":null,"export":["main"],"locals":"","instrCount":5}],"globals":[{"import":null,"export":["global"],"valType":"i64"}],"start":null,"tables":[],"memories":[],"tableExportNames":[],"memoryExportNames":[],"globalExportNames":["global"],"brTables":[],"originalFunctionImportsCount":1};
...
"call_I": function (func, instr, targetFunc, arg0_low, arg0_high) {
    Wasabi.analysis.call_pre({func, instr}, "call", targetFunc, [new Long(arg0_low, arg0_high)]);
},
"call_post": function (func, instr, ) {
    Wasabi.analysis.call_post({func, instr}, []);
},
"global_get_I": function (func, instr, index, value_low, value_high) {
    Wasabi.analysis.global({func, instr}, "global.get", index, new Long(value_low, value_high));
},
