...
Wasabi.module.info = {"functions":[{"type":"|","import":null,"export":["main"],"locals":"","instrCount":1}],"globals":[],"start":null,"tables":[],"memories":[],"tableExportNames":[],"memoryExportNames":[],"globalExportNames":[],"brTables":[],"originalFunctionImportsCount":0};
