...
Wasabi.module.info = {"functions":[{"type":"|","import":null,"export":["main"],"locals":"","instrCount":4}],"globals":[],"start":null,"tables":[],"memories":[{"import":["env","memory"],"export":["__wasabi_memory0"]}],"tableExportNames":[],"memoryExportNames":["__wasabi_memory0"],"globalExportNames":[],"brTables":[],"originalFunctionImportsCount":0};
