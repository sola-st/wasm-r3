...
Wasabi.module.info = {"functions":[{"type":"i|","import":["env","changeGlobal"],"export":[],"locals":"","instrCount":0},{"type":"|","import":null,"export":["main"],"locals":"","instrCount":5},{"type":"|","import":null,"export":["foo"],"locals":"","instrCount":3}],"globals":[{"import":null,"export":["global"],"valType":"i32"}],"start":null,"tables":[],"memories":[],"tableExportNames":[],"memoryExportNames":[],"globalExportNames":["global"],"brTables":[],"originalFunctionImportsCount":1};
