...
Wasabi.module.info = {"functions":[{"type":"|","import":["env","foo"],"export":[],"locals":"","instrCount":0},{"type":"|","import":["env2","bar"],"export":[],"locals":"","instrCount":0},{"type":"|","import":null,"export":["main"],"locals":"","instrCount":3}],"globals":[],"start":null,"tables":[],"memories":[],"tableExportNames":[],"memoryExportNames":[],"globalExportNames":[],"brTables":[],"originalFunctionImportsCount":2};
