...
Wasabi.module.info = {"functions":[{"type":"|","import":["env","changeGlobal"],"export":[],"locals":"","instrCount":0},{"type":"|","import":null,"export":["main"],"locals":"","instrCount":4}],"globals":[{"import":["env","global"],"export":["__wasabi_global0"],"valType":"i32"}],"start":null,"tables":[],"memories":[],"tableExportNames":[],"memoryExportNames":[],"globalExportNames":["__wasabi_global0"],"brTables":[],"originalFunctionImportsCount":1};
