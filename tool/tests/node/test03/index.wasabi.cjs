...
Wasabi.module.info = {"functions":[{"type":"ii|i","import":["env","add"],"export":[],"locals":"","instrCount":0},{"type":"|","import":null,"export":["main"],"locals":"","instrCount":9},{"type":"|","import":null,"export":["foo"],"locals":"","instrCount":4}],"globals":[],"start":null,"tables":[],"memories":[{"import":null,"export":["memory"]}],"tableExportNames":[],"memoryExportNames":["memory"],"globalExportNames":[],"brTables":[],"originalFunctionImportsCount":1};
