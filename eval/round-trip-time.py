...
#     stats = entry['stats']
#     trace_sizes.append((stats['relevantLoads'] + stats['relevantTableGets'] + stats['relevantGlobalGets'] +
...
# print('Times', relative_rg_means)
# print('Mean', np.mean(relative_rg_means))
# print('Standard deviation', np.std(relative_rg_means))
...
# plt.subplots_adjust(bottom=0.3)
# plt.savefig('rtt.pdf')
# print('Means', rt_means)
# print('Mean', np.mean(rt_means))
# print('Standard deviation', np.std(rt_means))
# plt.show()
...
#     'multiplyInt',
# ]
# with open('recordTime.json') as f:
#     data = json.load(f)
# record_means = []
# exec_means = []
# ratios = []
...
#     e = data[test]
#     rm = np.mean(e['record'])
#     record_means.append(rm)
#     em = np.mean(e['exec'])
#     exec_means.append(em)
#     ratio = rm / em
#     ratios.append(ratio)
# rm = np.mean(record_means)
# record_means.append(rm)
# em = np.mean(exec_means)
# exec_means.append(em)
# print(np.std(ratios))

# plt.bar(testcases, ratios)
# plt.bar([5], [rm / em], color='orange')
# plt.ylabel('Relative execution time (ms)')
# testcases.append('mean')
# plt.xticks(range(len(testcases)), testcases)
# plt.xlabel('Web applications')
# # plt.subplots_adjust(bottom=0.3)
# plt.axhline(y=1, color='black', linewidth=0.5)
# plt.savefig('record_time.pdf')
# # print('Means', rt_means)
# # print('Mean', np.mean(rt_means))
# # print('Standard deviation', np.std(rt_means))
# plt.show()
...
# replay time
# with open('replay-times.json') as f:
#     data = json.load(f)

# means = []
# for test in testcases:
#     means.append(np.mean(data[test]))

# print('Standard deviation', np.std(means))
# print('Mean', np.mean(means))
# plt.bar(testcases, means)
# plt.bar([17], [np.mean(means)], color='orange')
# plt.ylabel('Replay execution time (ms)')
# plt.xlabel('Web applications')
# plt.subplots_adjust(bottom=0.3)
# testcases.append('mean')
# plt.xticks(range(len(testcases)), testcases_plus_mean,
#            rotation=45, ha='right', fontsize=10)
# plt.savefig('replay-time.pdf')
# plt.show()
